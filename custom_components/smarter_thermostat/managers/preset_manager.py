...
from custom_components.smarter_thermostat.const import CONF_PRESETS, CONF_PRESETS_OLD
...
from custom_components.smarter_thermostat.managers.state_manager import StateManager
